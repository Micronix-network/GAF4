/*
 * $Id: Include.java,v 1.1.2.1 2013/11/20 15:27:50 riboldi01 Exp $
 *
...
@StrutsTag(name="include", tldTagClass="it.micronixnetwork.gaf.struts2.gui.jsp.IncludeTag", description="Include a servlet's output " +
                "(result of servlet or a JSP page)")
public class Include extends GAFComponent {
