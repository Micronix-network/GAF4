	...
	<#list cardModels as model>
		...
		<div id="${model.name}_properties_dialog" class="properties_dialog md-modal md-effect-1">
			<div class="md-content" style="width:550px;height:580px">
			        ...
			        <button id="${model.name}_properties_button_apply" class="md-button">${tag.getText('generic.properties.dialog.apply', 'Apply')}</button>
			        <button id="${model.name}_properties_button_close" class="md-button">${tag.getText('generic.properties.dialog.close', 'Close')}</button>
			        </div>
			</div>
		</div>
		</#if>
		...
		<div id="${model.name}_help_dialog" class="help_dialog md-modal md-effect-1">
			<div class="md-content" style="width:550px;height:580px">
			        ...
			        <div class="md-button-bar">
			        <button id="${model.name}_help_button_close" class="md-button">${tag.getText('generic.properties.dialog.close', 'Close')}</button>
			        </div>
			</div>
		</div>
